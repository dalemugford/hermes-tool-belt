...
> **2026-05-31 NOTE — DO NOT SHIP YET.** Headlines below were measured
> under per-turn narrowing. The cache-aware refactor (Phases 0-5
> landed; see [16.cache-aware-refactor-plan-2026-05-30.md](16.cache-aware-refactor-plan-2026-05-30.md))
> changes mechanism and accounting. The 57% / 3.37M numbers will need
> restatement after the corrected savings ledger has stable post-pivot
> data. Pause publication.
